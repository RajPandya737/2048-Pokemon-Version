...
public class EspBattle extends AppCompatActivity {
    Timer timer;
    MediaPlayer player;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_esp_battle);
    ...
    public void throwball(View view) {
        ...
        if (a != 1) {
            t.setText("You have caught the Espeon!");
            battle.setImageResource(R.drawable.s3after);

            timer = new Timer();
            timer.schedule(new TimerTask() {
                @Override
                public void run() {
                    Intent i = new Intent(EspBattle.this, GameScreen.class);
            ...
            timer.schedule(new TimerTask() {
                @Override
                public void run() {
                    Intent i = new Intent(EspBattle.this, LoseScreen.class);
                    player.stop();
                    startActivity(i);
                    finish();
                }
